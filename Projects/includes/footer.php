                    ...
                    <div class="footer-widget__contact">
                        ...
                        <ul class="list-unstyled footer-widget__contact-list">
                            <li>
                                ...
                                <div class="text">
                                    <p><a href="mailto:needhelp@company.com ">esptassam@gmail.com</a></p>
                                </div>
                            </li>
                            <li>
                                <div class="icon">
                        ...
                        Address:- Kazipara village, Chapar <br>
                        P.O:- Chapar <br>
                        District:- Dhubri, Assam, PIN- 783371, India.                                
                ...
                <div class="col-xl-12">
                    <div class="site-footer__bottom">
                        <div class="site-footer__bottom-inner">
                            <p class="site-footer__bottom-text">© Copyright 2023 by <a href="#">Ecosystem</a>
                            <a>Created by </a>
...
<div class="mobile-nav__wrapper">
    ...
    <div class="mobile-nav__content">
        ...
        <div class="logo-box">
            <a href="index-2.html" aria-label="logo image"><img src="assets/images/resources/logo-2.png" width="145"
                    alt="" /></a>
        </div>
        <!-- /.logo-box -->
